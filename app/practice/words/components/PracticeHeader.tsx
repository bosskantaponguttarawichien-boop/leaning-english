            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">
                        {isReviewMode ? "Daily Vocab Review 🧠" : "Practice Sessions"}
                    </h1>
                </div>
                ...
                <div className={`flex flex-col md:flex-row gap-6 transition-all duration-300 ${isStarted && difficultyMode === "typing" ? "hidden sm:flex" : ""}`}>
                    ...
                    <div className="flex flex-col gap-2 md:w-fit">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="grid grid-cols-2 sm:flex bg-zinc-50/50 dark:bg-zinc-800/80 p-1 rounded-2xl border border-zinc-100/50 dark:border-zinc-700/50 gap-1">
                                {MODES.map((mode) => (
                                    <button
                                        key={mode}
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 bg-zinc-50/50 dark:bg-zinc-800/80 px-4 py-2 rounded-2xl border border-zinc-100/50 dark:border-zinc-700/50">
                                {([
